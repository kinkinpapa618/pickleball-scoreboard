...
export default function TournamentManager() {
  ...
  const generateTournament = () => {
    ...
    // Bắn Toast thông báo
    showToast(
      `Đã tạo ${newMatches.length} trận đấu theo thể thức ${format.replace("_", " ")}`,
      "success",
    );
  };
            ...
            {matches.length > 0 ? (
                  ...
                  <Card className="bg-slate-900/80 border-white/5 rounded-3xl relative overflow-hidden group hover:border-[#ccff00]/30 transition-all">
                    <CardContent className="p-6">
                      <div className="flex justify-between items-center mb-4 border-b border-white/5 pb-3">
                        ...
                        {m.group && (
                          <span className="bg-[#ccff00] text-black text-[8px] font-black px-2 py-0.5 rounded-full uppercase">
                            {m.group}
                          </span>
                        )}
                      </div>
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="relative h-px bg-white/5 w-full flex items-center justify-center">
                          <div className="absolute bg-[#050505] px-3 text-[10px] font-black italic text-white/10 group-hover:text-[#ccff00] transition-colors">
                            VS
                          </div>
                        </div>
                        <div className="flex justify-between items-center">
              ...
              >
                ...
                <p className="text-white/20 font-black italic uppercase text-sm tracking-widest">
                  Hãy chọn thể thức và bấm Generate
                </p>
              </motion.div>
            )}
          </AnimatePresence>
